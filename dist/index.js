...
(() => {
  ...
  function conceptAnimCards() {
    const slides = gsapWithCSS.utils.toArray(".concept-v2_slide");
    slides.forEach((slide2) => {
      const cards = slide2.querySelectorAll(".concept-v2_cards");
      gsapWithCSS.set(cards, { rotationY: -90, filter: "blur(0rem)" });
  ...
  function videoControl() {
    ...
    slidesVideo.forEach((slide2) => {
      observerVideo.observe(slide2);
    });
  }
